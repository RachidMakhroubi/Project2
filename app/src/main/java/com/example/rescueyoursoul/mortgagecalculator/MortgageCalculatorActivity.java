//CIT 243 T1
//// Android Project 1
// Rachid Makhroubi, Yassin Balaj, Soukaina sahili

package com.example.rescueyoursoul.mortgagecalculator;
...
public class MortgageCalculatorActivity extends Activity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mortgage_calculator); // set layout with .xml file
